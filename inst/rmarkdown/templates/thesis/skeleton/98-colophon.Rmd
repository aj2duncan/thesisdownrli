...
It was written in R Markdown and $\LaTeX$, and rendered into PDF using [thesisdownrli](https://github.com/aj2duncan/thesisdownrli) and [bookdown](https://github.com/rstudio/bookdown). 
